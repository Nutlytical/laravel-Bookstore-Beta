			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav mx-auto">
						...
						<li class="nav-item px-lg-4">
							<a class="nav-link text-uppercase" href="{{route('products')}}"
								>Products</a
							>
						</li>
						{{-- @if (Route::has('login'))
						...
						@if(Auth::check())
							<li class="nav-item px-lg-4">
								<a class="nav-link text-uppercase" href="{{route('showCart')}}">
									<i class="fas fa-shopping-cart fs-4"></i>
									@if(isset($cartItems))
										<span class="badge rounded-pill bg bg-primary">{{$cartItems->totalQuantity}}</span>
									@endif
								</a>
							</li>
